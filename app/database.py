...
NOTA SOBRE VERCEL: el filesystem en serverless es efímero (excepto /tmp,
también efímero entre invocaciones). En producción real conviene usar
Postgres administrado (Neon, Supabase, Vercel Postgres). Para el prototipo
demo usamos SQLite en /tmp en Vercel y data/ en local.
"""
