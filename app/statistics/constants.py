"""Constantes para gráficos de control (Montgomery, Statistical Quality Control)."""

# Tamaño de subgrupo (n) -> constantes
# Válido para n = 2..25
...
D4 = {
    2: 3.267, 3: 2.575, 4: 2.282, 5: 2.115, 6: 2.004, 7: 1.924, 8: 1.864,
...
B3 = {
    ...
    11: 0.321, 12: 0.354, 13: 0.382, 14: 0.406, 15: 0.428, 16: 0.448,
    17: 0.466, 18: 0.482, 19: 0.497, 20: 0.510, 21: 0.523, 22: 0.534,
...
# d2: para estimar sigma a partir de R (sigma = R_bar / d2)
d2 = {
...
# c4: para estimar sigma a partir de S (sigma = S_bar / c4)
c4 = {
...
def get_constants_xr(n: int) -> dict:
    if n < 2 or n > 25:
        raise ValueError(f"Tamaño de subgrupo no soportado: {n}. Debe estar entre 2 y 25.")
    return {"A2": A2[n], "D3": D3[n], "D4": D4[n], "d2": d2[n]}


def get_constants_xs(n: int) -> dict:
    if n < 2 or n > 25:
        raise ValueError(f"Tamaño de subgrupo no soportado: {n}. Debe estar entre 2 y 25.")
    return {"A3": A3[n], "B3": B3[n], "B4": B4[n], "c4": c4[n]}
